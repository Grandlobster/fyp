...
public class PatientV3Service {
  ...
  public FacadeV3Response upsertPatients(List<Patient> patients) {
    ...
    for (Patient patient : patients) {
      ...
      document.append(FieldIdentifiers.EMAIL, patient.getEmail());
    ...
    .map(
      cc ->
        new Document()
            .append("referenceNumber", cc.getReferenceNumber())
            .append("display", cc.getDisplay())
            .append("hiType", cc.getHiType())
            .append("studyUID", cc.getStudyUID())
            .append("seriesUID", cc.getSeriesUID())
            .append("modality", cc.getModality())
            .append("hospitalId", cc.getHospitalId())
            .append("hospitalName", cc.getHospitalName())
            .append("pacsEndpoint", cc.getPacsEndpoint())
            .append("kmeEndpoint", cc.getKmeEndpoint())
            .append("qkdNodeId", cc.getQkdNodeId())
            .append("ipsecGateway", cc.getIpsecGateway())
            .append("sha256Hash", cc.getSha256Hash()))
      .collect(Collectors.toList());

    update.append(
      "$addToSet",
      new Document(
      FieldIdentifiers.CARE_CONTEXTS,
      new Document("$each", careContextDocs)));
      }
